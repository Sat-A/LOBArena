...
def _write_multi_window_plots(summary: dict, out_dir: Path) -> None:
    ...
    sns.lineplot(x=x, y=raw_scores, marker="o", linewidth=2.0, label="Raw PnL", ax=ax, color="C0")
    sns.lineplot(x=x, y=risk_scores, marker="o", linewidth=2.0, label="Risk-adjusted PnL", ax=ax, color="C1")
    ax.set_xticks(x)
    ax.set_xticklabels(labels, rotation=20, ha="right")
    ax.set_title("Multi-window scores by window", fontsize=16, fontweight="bold", loc="left", pad=12)
    ...
    ax.set_ylim(-1, 3)
    ax.set_title("Aggregated multi-window scores", fontsize=16, fontweight="bold", loc="left", pad=12)
